...
- [x] **TEST-02**: Integration test suite covers API endpoints (Ingest -> Search)
- [x] **TEST-03**: Frontend components have basic unit tests (Vitest)

### Hardening
- [x] **HARD-01**: Extension handles 401 Unauthorized errors with login prompt
- [x] **HARD-02**: Watchers support authenticated requests (API Key/Token)
